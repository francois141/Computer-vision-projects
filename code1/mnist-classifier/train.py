...
def run_training_epoch(net, optimizer, dataloader):
    ...
    for batch in tqdm(dataloader):
        ...
        loss = loss_function(output,batch['annotation'])
...
if __name__ == '__main__':
    ...
    print("MLP parameters : " + str(sum(p.numel() for p in net.parameters())))

    net = ConvClassifier()

    print("CNN parameters : " + str(sum(p.numel() for p in net.parameters())))
